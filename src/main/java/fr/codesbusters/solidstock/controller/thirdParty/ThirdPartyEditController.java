...
@Slf4j
@Controller
public class ThirdPartyEditController extends DefaultShowController implements Initializable {
    ...
    @FXML
    public void editThirdParty() throws NumberFormatException, UnsupportedEncodingException {
        ...
        openDialog(stackPane.getScene(), "Tiers " + thirdPartyLastName + " " + thirdPartyFirstName + " modifié avec succès", DialogType.INFORMATION, 0);
    }
