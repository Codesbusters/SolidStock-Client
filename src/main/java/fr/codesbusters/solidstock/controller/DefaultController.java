...
public class DefaultController {
    ...
    public void openThirdPartySelector(Scene scene, ThirdPartySelectorListener listener) {
        try {
            Stage primaryStage = (Stage) scene.getWindow();

            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/selector/thirdPartySelector.fxml"));
            Parent root = loader.load();
            Scene newScene = new Scene(root);
            MFXThemeManager.addOn(newScene, Themes.DEFAULT, Themes.LEGACY);
            ...
            Stage popupStage = new Stage();
            popupStage.setResizable(false);
            popupStage.setTitle("Sélectionner un tier");
            Image icon = new Image("/img/icon.png");
            popupStage.getIcons().add(icon);
            ...
            ThirdPartySelectorController controller = loader.getController();
            controller.setStage(popupStage);
            controller.setListener(listener);
