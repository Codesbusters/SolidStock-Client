...
package fr.codesbusters.solidstock.skin;
 ...
 */
public class SSDoubleFieldSkin extends SkinBase<SSDoubleField> {
    private static final PseudoClass FOCUS_WITHIN_PSEUDO_CLASS = PseudoClass.getPseudoClass("focus-within");
    //================================================================================
    // Properties
    //================================================================================
    private final BoundDoubleField boundField;
    ...
    // Constructors
    //================================================================================
    public SSDoubleFieldSkin(SSDoubleField textField, BoundDoubleField boundField) {
        super(textField);
    ...
    private void addListeners() {
        SSDoubleField textField = getSkinnable();
